  ...
  return (
    <footer className="bg-gray-900 text-gray-400 py-10 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-white font-bold text-lg mb-2">Lander Generation</h3>
      ...
      <p className="text-center text-xs mt-8">© {new Date().getFullYear()} Lander Generation. All rights reserved.</p>
    </footer>
  );
}
