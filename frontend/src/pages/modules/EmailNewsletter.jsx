...
import { EMAIL_TEMPLATES, generateDesktopLPPage, applyNewsletterAdvancedStyles, applyScrollableWidgetBackground } from "../../utils/templates";
...
export default function EmailNewsletter() {
  ...
  const [form, setForm]         = useState({
    ...
    scrollBgDesktopImages: ["", "", ""], scrollBgPhoneImages: ["", "", ""],
  ...
  const emailHtml = useMemo(() => {
    ...
    if (!html) return "";
    const styled = applyNewsletterAdvancedStyles(html, {
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl font-bold text-slate-900">
          <i className="fa-solid fa-envelope-open-text mr-2" style={{ color: "#059669" }} />Email Newsletter Generator
        </h1>
      ...
      {step === 0 && (
        ...
        <div className="card max-w-lg w-full">
          <h2 className="flex items-center gap-3 font-semibold text-slate-800 mb-5">
          ...
          <div className="space-y-4">
            ...
            <button className="btn-primary px-7 font-semibold text-white"
        ...
        <div className="hidden lg:block flex-1 bg-emerald-50/40 rounded-lg p-6 self-stretch">
          <p className="text-sm font-semibold text-slate-800 mb-3">
            <i className="fa-solid fa-lightbulb mr-2 text-emerald-600" />Tips for your newsletter signup
          </p>
          <ul className="space-y-2.5 text-sm text-slate-600">
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Give your newsletter topic a clear focus — it helps AI write more relevant copy.</span></li>
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Connect a Google Sheet to automatically collect subscriber emails as they sign up.</span></li>
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Use "Create LP for Desktop" to pair the signup popup with a full blog landing page.</span></li>
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Keep the project name descriptive — you'll use it to find this campaign later.</span></li>
          </ul>
        </div>
        </div>
      )}
          ...
          {!mode && (
            <div>
              <h2 className="font-semibold text-slate-800 mb-4">
                <i className="fa-solid fa-swatchbook mr-2 text-emerald-500" />How do you want to create this newsletter?
              </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              {/* Popup image */}
              <div className="border border-slate-100 rounded-lg p-3 bg-slate-50">
                <p className="text-xs font-semibold text-slate-700 mb-2"><i className="fa-solid fa-image mr-1.5 text-emerald-500" />Popup Image</p>
                ...
                {form.image ? (
                  ...
                  <label className="flex flex-col items-center justify-center gap-1.5 border-2 border-dashed border-slate-200 rounded-lg py-4 cursor-pointer hover:border-emerald-300 hover:bg-emerald-50/30 transition-colors">
              ...
              <div className="border border-slate-100 rounded-lg p-3 bg-slate-50">
                <p className="text-xs font-semibold text-slate-700 mb-2"><i className="fa-solid fa-fill-drip mr-1.5 text-emerald-500" />Background (behind popup)</p>
                <div className="flex gap-2 mb-2">
                  <button type="button" className={`flex-1 text-xs font-semibold py-1.5 rounded-md border ${form.bgType === "color" ? "bg-emerald-500 text-white border-emerald-500" : "bg-white text-slate-600 border-slate-200"}`} onClick={() => setForm({ ...form, bgType: "color" })}><i className="fa-solid fa-fill-drip mr-1" />Color</button>
                  <button type="button" className={`flex-1 text-xs font-semibold py-1.5 rounded-md border ${form.bgType === "image" ? "bg-emerald-500 text-white border-emerald-500" : "bg-white text-slate-600 border-slate-200"}`} onClick={() => setForm({ ...form, bgType: "image" })}><i className="fa-solid fa-image mr-1" />Image</button>
                </div>
                {form.bgType === "color" ? (
              ...
              <div className="border border-slate-100 rounded-lg p-3 bg-slate-50">
                <label className="flex items-center gap-2 mb-3 cursor-pointer">
                  <input type="checkbox" checked={form.advancedEnabled} onChange={e => setForm({ ...form, advancedEnabled: e.target.checked })} className="w-4 h-4 accent-emerald-500" />
                  <span className="text-xs font-semibold text-slate-700"><i className="fa-solid fa-sliders mr-1.5 text-emerald-500" />Advanced — Heading, Sub-content &amp; Button</span>
                </label>
          ...
          <div className="card self-start lg:sticky lg:top-6">
            ...
            {emailHtml
              ? <DevicePreviewFrame html={emailHtml} height={340} title="preview" />
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-slate-800">
                  <i className="fa-solid fa-inbox mr-2 text-emerald-500" />Subscribers
