...
import { AGE_TEMPLATES, generateDesktopLPPage, applyAgeAdvancedStyles, applyScrollableWidgetBackground } from "../../utils/templates";
...
export default function AgeVerification() {
  ...
  const consentHtml = useMemo(() => {
    ...
    if (!html) return "";
    const styled = applyAgeAdvancedStyles(html, {
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl font-bold text-slate-900">
          <i className="fa-solid fa-shield-halved mr-2" style={{ color: "#059669" }} />Age Verification Generator
        </h1>
      ...
      {step === 0 && (
        ...
        <div className="hidden lg:block flex-1 bg-emerald-50/40 rounded-lg p-6 self-stretch">
          <p className="text-sm font-semibold text-slate-800 mb-3">
            <i className="fa-solid fa-lightbulb mr-2 text-emerald-600" />Tips for your age gate
          </p>
          <ul className="space-y-2.5 text-sm text-slate-600">
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Pick a minimum age that matches your product or region's legal requirement.</span></li>
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Use "Create LP for Desktop" to show desktop visitors a blog page while mobile visitors still see the age gate.</span></li>
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Set a clear exit redirect so visitors who decline have somewhere safe to go.</span></li>
            <li className="flex gap-2"><i className="fa-solid fa-check text-emerald-600 mt-0.5" /><span>Keep the project name descriptive — you'll use it to find this page later.</span></li>
          </ul>
        </div>
        </div>
      )}
          ...
          {!mode && (
            <div>
              <h2 className="font-semibold text-slate-800 mb-4">
                <i className="fa-solid fa-swatchbook mr-2 text-emerald-500" />How do you want to create this age gate?
              </h2>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-semibold text-slate-800">
                  <i className="fa-solid fa-swatchbook mr-2 text-emerald-500" />
              ...
              {mode === "ai" && (
                <div className="card max-w-lg mb-6">
                  <p className="text-xs font-semibold text-slate-700 mb-2">
                    <i className="fa-solid fa-image mr-1.5 text-emerald-500" />Optional — match a screenshot
                  </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              <div className="border border-slate-100 rounded-lg p-3 bg-slate-50">
                <p className="text-xs font-semibold text-slate-700 mb-2">
                  <i className="fa-solid fa-fill-drip mr-1.5 text-emerald-500" />Background
                </p>
              ...
              <div className="border border-slate-100 rounded-lg p-3 bg-slate-50">
                <label className="flex items-center gap-2 mb-3 cursor-pointer">
                  <input type="checkbox" checked={form.advancedEnabled}
                    ...
                    className="w-4 h-4 accent-emerald-500" />
                  <span className="text-xs font-semibold text-slate-700">
                    <i className="fa-solid fa-sliders mr-1.5 text-emerald-500" />Advanced — Heading, Subheading &amp; Buttons
                  </span>
                </label>
